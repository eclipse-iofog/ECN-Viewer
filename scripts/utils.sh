#!/usr/bin/env sh
# utils.sh - a set of helper functions for use throughout our shell scripts
#
# Usage : . ./utils.sh (or whatever path you need)
...
#
# Ensure that all required python modules are installed
#
checkForRequirements() (
	python3 -m pip install -r ./python_helpers/requirements.txt > /dev/null
)
